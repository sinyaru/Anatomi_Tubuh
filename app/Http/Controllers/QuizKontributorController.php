...
class QuizKontributorController extends Controller
{
    public function index()
    {
        $quiz = Quiz::all();
        return view('kontributor.quiz.index', compact('quiz'));
    }

    public function create()
    {
        return view('kontributor.quiz.create');
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('kontributor.quiz.index')->with('success', 'Quiz berhasil ditambahkan');
    }

    public function edit($id)
    {
        $quiz = Quiz::findOrFail($id);
        return view('kontributor.quiz.edit', compact('quiz'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('kontributor.quiz.index')->with('success', 'Quiz berhasil diperbarui');
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect()->route('kontributor.quiz.index')->with('success', 'Quiz berhasil dihapus');
    }
}
