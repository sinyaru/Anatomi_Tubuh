...
class HasilQuizKontributorController extends Controller
{
    // Tampilkan semua hasil quiz
    public function index()
    {
        $data = HasilQuiz::orderBy('created_at', 'DESC')->get();
        return view('kontributor.hasil_quiz.index', compact('data'));
    }
    ...
    public function show($id)
    {
        ...
        return view('kontributor.hasil_quiz.show', compact('user'));
    }
    ...
    {
        $user = HasilQuiz::findOrFail($id);
        return view('kontributor.hasil_quiz.edit', compact('user'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('kontributor.hasil-quiz.index')
