...
class OrganController extends Controller
{
    ...
    {
        $data = Organ::all();
        return view('admin.organ.index', compact('data'));
    }

    public function create()
    {
        $kategori = Kategori::all();
        return view('admin.organ.create', compact('kategori'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('organ.index')->with('success', 'Organ berhasil ditambahkan');
    }
    ...
    public function edit($id)
    {
        ...
        $kategori = Kategori::all();
        return view('admin.organ.edit', compact('data', 'kategori'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('organ.index')->with('success', 'Organ berhasil diperbarui');
    }
