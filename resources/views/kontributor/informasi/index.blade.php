...
<div class="info-container">
    ...
    <a href="{{ route('kontributor.informasi.create') }}" class="btn btn-pink mb-3">
        + Tambah Informasi
    </a>
        ...
        <tbody>
            @foreach ($informasi as $info)
                <tr>
                    ...
                    <td>
                        <a href="{{ route('kontributor.informasi.edit', $info->id) }}" 
                        ...
                        <form id="delete-form-{{ $info->id }}" 
                              action="{{ route('kontributor.informasi.destroy', $info->id) }}" 
                              method="POST" 
                              style="display: none;">
                            @csrf
                            @method('DELETE')
